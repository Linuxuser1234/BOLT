...
public class SCBC implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Station.getItems().add("OUN");
        Station.getItems().add("KCDA");
        Station.getItems().add("KBTV");
        Station.getItems().add("KMPV");
        Station.getItems().add("KMSS");
        Station.getItems().add("LOWL");
    }
}